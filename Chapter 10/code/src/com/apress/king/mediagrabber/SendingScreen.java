...
public class SendingScreen extends MainScreen implements MediaGrabberResource
{
    ...
    private MenuItem selectItem = new MenuItem(r
            .getString(I18N_COMMAND_CHOOSE_CONTACT), 0, 0)
    {
        public void run()
        {
            selectRecipient();
            ...
            byte[] data, boolean encrypt)
    {
        ...
        status = new LabelField(r.getString(I18N_PROMPT_EMAIL));
        receiver = new BasicEditField(r.getString(I18N_LABEL_RECIPIENT), "",
            ...
            CryptoException, IOException
    {
        ...
        {
            String pattern = r
                    .getString(MediaGrabber.I18N_EMAIL_BODY_ENCRYPTED);
        ...
        {
            text.setContent(r.getString(I18N_EMAIL_BODY_DEFAULT));
        }
    ...
    private void send()
    {
        status.setText(r.getString(I18N_STATUS_SENDING));
        state = STATE_SENDING;
    ...
    private class MessageSender implements Runnable
    {
        public void run()
        {
            ...
            try
            {
                ...
                updater.sendDelayedMessage(r.getString(I18N_STATUS_SENT));
                state = STATE_SENT;
            }
            catch (Exception e)
            {
                updater.sendDelayedMessage(r.getString(I18N_ERROR_SENDING)
                        + e.getMessage());
                e.printStackTrace();
            }
        }
